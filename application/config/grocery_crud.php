<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'gif|jpeg|jpg|png|pdf';
	...
	$config['grocery_crud_file_upload_max_file_size'] 			= '2MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)

	//You can choose 'ckeditor','tinymce' or 'markitup'
	$config['grocery_crud_default_text_editor'] = '';
